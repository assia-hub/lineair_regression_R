# Fonction 1 : # Comparaison estimation - coefficients réels
...
# Fonction 3 : Affichage de ces résultats
...
# Fonction 4 : Affichage des résultats en histogramme
